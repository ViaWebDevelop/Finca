...
const renderFinancesList = (data) => {
  ...
  const actionText = document.createTextNode("Acción");
  ...
  data.map ((item) => {
    ...
    const deleteText = document.createTextNode("Eliminar");
...
const renderFinanceElements = (data) => {
  ...
  const totalSubtext = document.createTextNode("Total de Movimientos")
  ...
  const revenuesSubtext = document.createTextNode("Ingresos")
  ...
  const expensesSubtext = document.createTextNode("Egresos")
  ...
  const totalValueSubtext = document.createTextNode("Balance")
...
const onLoadUserInfo = () => {
  ...
  const logoutText = document.createTextNode("Salir");
...
const onCreateFinanceRelease = async (target) => {
  try {
    ...
    if (result.error) {
      alert("Error al agregar nuevos datos financieros.");
      return;
    }
    onCloseModal();
    onLoadFinancesData();
